...
class MoreOptionspostWidget extends StatefulWidget {
  const MoreOptionspostWidget({Key key}) : super(key: key);

  @override
  _MoreOptionspostWidgetState createState() => _MoreOptionspostWidgetState();
}

class _MoreOptionspostWidgetState extends State<MoreOptionspostWidget> {
  @override

...
import '../createpet_profile/createpet_profile_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final yourprofileUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if ((yourprofileUsersRecord.premium) == 'Yes')
                            Image.asset(
                                  ...
                                  stream: queryDogsRecord(
                                    queryBuilder: (dogsRecord) =>
                                        dogsRecord.where('userAssociation',
                                            isEqualTo: yourprofileUsersRecord
                                                .reference),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
